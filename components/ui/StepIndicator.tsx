            ...
            return (
              <li key={step.id} className="flex items-center">
                <div className="flex flex-col items-center">
                  <div
                    className={clsx(
                      'flex items-center justify-center w-12 h-12 rounded-full text-sm font-bold border-2 transition-all duration-300',
                      {
                ...
                {index < steps.length - 1 && (
                  <div className="hidden sm:block w-16 h-0.5 bg-slate-600 ml-4" />
                )}
              </li>
            )
          })}
